...
public class Graph : MonoBehaviour
{
    ...
    public enum GraphFunctionName { Sine, MultiSine, Sine2D, MultiSine2D, Ripple};
    ...
    private void Update()
    {
        ...
        GraphFunction[] functions= {SineFunction,MultiSineFunction, Sine2DFunction, MultiSine2DFunction, Ripple};
